...
def encode_image(text_to_encode, template_image="images/cam1.jpg"):
    ...
    encoded_image.save("G:/final year project coding 2019 2020/054 image lossless compression/encodedimage/encoded_image.png")


if __name__ == '__main__':
    decode_image()
    encode_image("ningesh here with new ideas")