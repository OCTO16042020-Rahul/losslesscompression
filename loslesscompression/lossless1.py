...
def decode_image(file_location,decodeimage2):
    ...
    decoded_image.save("static/decodeimage/" + decodeimage2)
...
def encode_image(text_to_encode, template_image,imgname1):
    ...
    encoded_image.save("static/encodeimage/" + imgname1)
